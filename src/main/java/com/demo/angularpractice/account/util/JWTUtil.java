...
//        claims.put("urls", ((UserParam) userDetails).getResources());
//        claims.put("roles", ((UserParam) userDetails).getAuthorities());
...
//		System.out.println(((UserParam)claimsFromToken).toString());
